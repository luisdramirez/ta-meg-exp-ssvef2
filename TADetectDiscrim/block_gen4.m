...
if generateRuns
    ...
    validity = a(:,3);
    validity(validity==2) = 1; % valid
    validity(validity==3) = 1; % valid
    validity(validity==4) = 2; % invalid
    validity(validity==5) = 3; % neutral
    a(:,3) = validity;
...
%     idx = 1:size(a,1);
    ...
    cueType(cue==3 & target==1) = 6;
    cueType(cue==3 & target==2) = 7;
